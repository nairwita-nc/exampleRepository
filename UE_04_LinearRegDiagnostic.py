...
class LinearRegDiagnostic:
    ...
    def plot_all(self):
        print("creating all 4 diagnostic plots at once")
        
        fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(12, 10))
        
        self.residual_plot(ax=ax1)
        self.qq_plot(ax=ax2)
        self.scale_location_plot(ax=ax3)
        self.leverage_plot(ax=ax4)
        
        plt.tight_layout()
        
        print("4 diagnostic plots created")
        return fig